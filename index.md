...
### 11. [2주차 작업 결과](files/w10/index.md)
### 11. [3주차 작업 결과](files/w11/index.md)
### 11. [4주차 작업 결과](files/w12/index.md)
### 11. [5주차 작업 결과](files/w13/index.md)
### 11. [6주차 작업 결과](files/w14/index.md)
...
12. 맵에 스폰되는 장애물에 레이저와 총알은 막힌다.
13. 제한시간 혹은 플레이어의 HP가 0이 되었을 경우 Game Over UI를 띄우고 게임을 멈춘다.
14. Game Over UI 밑에는 다시하기와 나가기 버튼이 있다.
...
7. 플레이 할 때 화면 왼쪽 위에는 제한시간 가운데에는 현재 플레이 시간을 표시한다.
...
6. player 1,2,3에 따라 이동속도 HP값을 달리 한다.
7. Ai 1,2,3에 따라 총의 발사속도, 발사하는 탄의 개수를 달리 한다.
8. 플레이어의 위치, 랜덤한 위치 혹은 두곳 모두에 랜덤으로 총을 발사한다.
...
13. 플레이어가 파란색 레이저에 피격 시 플레이어의 HP를 올린다.
